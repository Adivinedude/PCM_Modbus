...
#ifndef Stepper__compact_h
#define Stepper__compact_h
#define make_me_smaller
...
class Stepper {
  public:
    // constructors:
    Stepper();
    void Setup(uint16_t number_of_steps, uint8_t motor_pin_1, uint8_t motor_pin_2,
                                 uint8_t motor_pin_3, uint8_t motor_pin_4);
    // speed setter method:
    void setSpeed(long whatSpeed);    //units per minute
    void setSteps(long howManySteps); //steps per second
